...
const (
	...
	FinOpsServiceName = "finops.v1.FinOpsService"
)
...
const (
	...
	// ValidateBudget RPC.
	FinOpsServiceValidateBudgetProcedure = "/finops.v1.FinOpsService/ValidateBudget"
	// FinOpsServiceEstimateCostProcedure is the fully-qualified name of the FinOpsService's
	// EstimateCost RPC.
	FinOpsServiceEstimateCostProcedure = "/finops.v1.FinOpsService/EstimateCost"
	// FinOpsServiceTrackUsageProcedure is the fully-qualified name of the FinOpsService's TrackUsage
	// RPC.
	FinOpsServiceTrackUsageProcedure = "/finops.v1.FinOpsService/TrackUsage"
)

// FinOpsServiceClient is a client for the finops.v1.FinOpsService service.
...
// NewFinOpsServiceClient constructs a client for the finops.v1.FinOpsService service. By default,
...
func NewFinOpsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FinOpsServiceClient {
	...
	finOpsServiceMethods := v1.File_finops_v1_finops_proto.Services().ByName("FinOpsService").Methods()
...
// ValidateBudget calls finops.v1.FinOpsService.ValidateBudget.
...
// EstimateCost calls finops.v1.FinOpsService.EstimateCost.
...
// TrackUsage calls finops.v1.FinOpsService.TrackUsage.
...
// FinOpsServiceHandler is an implementation of the finops.v1.FinOpsService service.
...
func NewFinOpsServiceHandler(svc FinOpsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/finops.v1.FinOpsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFinOpsServiceHandler) ValidateBudget(context.Context, *connect.Request[v1.ValidateBudgetRequest]) (*connect.Response[v1.ValidateBudgetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finops.v1.FinOpsService.ValidateBudget is not implemented"))
}
...
func (UnimplementedFinOpsServiceHandler) EstimateCost(context.Context, *connect.Request[v1.EstimateCostRequest]) (*connect.Response[v1.EstimateCostResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finops.v1.FinOpsService.EstimateCost is not implemented"))
}
...
func (UnimplementedFinOpsServiceHandler) TrackUsage(context.Context, *connect.Request[v1.TrackUsageRequest]) (*connect.Response[v1.TrackUsageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finops.v1.FinOpsService.TrackUsage is not implemented"))
}
